...
[![image](https://img.shields.io/pypi/v/ruff-odoo/0.16.2.10.svg)](https://pypi.python.org/pypi/ruff-odoo)
[![image](https://img.shields.io/pypi/l/ruff-odoo/0.16.2.10.svg)](https://pypi.python.org/pypi/ruff-odoo)
[![image](https://img.shields.io/pypi/pyversions/ruff-odoo/0.16.2.10.svg)](https://pypi.python.org/pypi/ruff-odoo)
...
[[repos]]
repo = "https://github.com/vauxoo/ruff-odoo-pre-commit"
rev = "0.16.2.10" # ruff-odoo version.
hooks = [
  # Run the linter.
